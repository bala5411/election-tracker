...
# Dictionary to bridge ECI clean names to the map's messy GeoJSON spellings
NAME_MAPPING = {
    "Ponneri": "Ponneri (SC)",
    "Poonamallee": "Poonamallee (SC)",
    "Thiruvottiyur": "Tiruvottiyur",
    "Arakkonam": "Arakkonam (SC)",
    ...
    "Harur": "Harur (SC)",
    "Pappireddippatti": "Pappireddippatti",
    "Papireddipatti": "Pappireddippatti", 
    "Vanur": "Vanur (SC)",
    "Yercaud": "Yercaud (ST)",
    ...
    "Sirkazhi": "Sirkazhi (SC)",
    "Avinashi": "Avanashi (SC)",
    ...
    "Thiruthuraipoondi": "Thiruthuraipoondi(SC)",
    "Nilakkottai": "Nilakkottai (SC)",
